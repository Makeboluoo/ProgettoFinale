...
public class MyEventsControllerGETTest {
    ...
    public void testMyEvents() throws Exception {
        ...
        when(eventFacade.myEvents(userModel)).thenReturn(events);

        mockMvc.perform(MockMvcRequestBuilders.get("/event/myEvents").with(user(userDetails)))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.view().name("events/my_events"))
